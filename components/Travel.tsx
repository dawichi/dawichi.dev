...
const Travel = () => (
	<div className='max-w-5xl mx-auto mt-40 p-5'>
		...
		<p className='my-5 text-center'>
			...
			different countries throughout my life. Luckily, in software development we have the ability to work
			from where we want and for whoever we want through the internet. What an amazing job.
		</p>
		<Map />
	</div>
)

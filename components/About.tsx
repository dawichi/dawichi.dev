		...
		<div className='container mx-auto mt-40 p-5'>
			...
			<div className='grid lg:grid-cols-3 mt-5'>
				<div className={`lg:col-span-2 ${setClassName()}`}>
					<p>Hi! I'm a <b>software developer</b> based in Galiza (Spain), who works with {tint('JavaScript')} and {tint('Python')}.</p>
					<p>My favourite tools are <b className="code re">React</b> based technologies, as React Native and NEXT.js.</p>
					<br/>
					
					<p>I invest my free time in continuing to improve myself as a developer and <b>never stop learning</b>.</p>
					<p>I'm currently studying software engineering in the Universitat Oberta de Catalunya.</p>
					<br/>

					<p>
						I try to contribute and publish good <b>open source</b> code, always thinking on what could be useful or interesting for others. I have <b>colaborated with remote developers</b> on small projects for fun, and I believe that being surrounded by the correct people is the best asset to succeed. I'm also fascinated by UI design, so I always try to make any project look it's best in terms of <b>aesthetics and usability</b>.
					</p>
				</div>
				<div><img src="/assets/svg/github.svg" className='opacity-90 mx-auto m-5 w-3/4 md:w-full' alt=""/></div>
			</div>
		</div>
	)
}

...
export default function Navbar() {
	...
	return (
		<Disclosure as="nav" id="navboxshadow" className="bg-white/50 dark:bg-zinc-800 sticky top-0 opacity-90 backdrop-blur-xl transition-shadow ease-in-out duration-400 z-10">
			{({ open }) => (
				<>

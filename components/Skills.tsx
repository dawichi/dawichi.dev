...
export default function Skills() {
	...
	return (
		<div>
			<div className='text-center p-10 text-2xl bg-white/50 dark:bg-zinc-800 skew-y-6 shadow-lg dark:shadow-zinc-700'>
				<h3>Web development <br/> <i className="bi bi-code-slash"></i></h3> 
			</div>
							...
							{ section.skills.map((skill, idx_skill) => (
								<div key={idx_skill}>
									...
									<div className='bg-zinc-200 dark:bg-zinc-700 h-2 rounded'>
										<div className='bg-teal-500 h-2 rounded' style={{width: `${skill.percent}%`}}></div>
									</div>
									<br/>
								</div>
							))}

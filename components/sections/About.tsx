			...
			<Row>
				<Col xs={12} lg={7}>
					<div className={styles.text}>
						...
						<p className={setClassName()}>
							I invest my free time in continuing to improve myself as a developer and <b>never stop learning</b>. I'm currently studying in <a href="https://www.freecodecamp.org/" target="_blank">freecodecamp</a> and <a href="https://platzi.com/" target="_blank">Platzi</a>, getting better in python.
						</p>
						<p  className={setClassName()}>
				...
				<Col xs={12} lg={5}>
					<img src="/assets/svg/github.svg" className={styles.meSvg} alt=""/>
				</Col>
			</Row>
		</Container>
	)

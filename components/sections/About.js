			...
			<Row>
				<Col xs={12} lg={7}>
					<div className={styles.text}>
						...
						<p className={setClassName()}>
							I invest my free time in continuing to improve myself as a developer and <b>never stop learning</b>. I'm currently studying in <a href="https://www.freecodecamp.org/">freecodecamp</a>, getting better in python.
						</p>
						<p  className={setClassName()}>
